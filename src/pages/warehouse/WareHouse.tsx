      ...
      <Table>
        <TableHeader className="border-gray-100 dark:border-gray-800 border-b">
          <TableRow className="w-full mx-3">
            <TableCell className="font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400 p-3">Name</TableCell>
            <TableCell className="font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400 p-3">Qty</TableCell>
            <TableCell className="font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400 p-3">Raw</TableCell>
            <TableCell className="font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400 p-3">Column</TableCell>
            <TableCell className="font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400 p-3">Price</TableCell>
            <TableCell className="font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400 p-3">Action</TableCell>
          </TableRow>
        </TableHeader>
