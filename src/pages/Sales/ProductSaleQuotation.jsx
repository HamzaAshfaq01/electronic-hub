...
export default function ProductSaleQuotation() {
		...
		<div>
			<div className='mb-6'>
				<div className='flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between px-4'>
					<div>
						<h3 className='text-lg font-semibold text-[#212121] dark:text-white/90'>Sale Quotation</h3>
					</div>
										...
										<TableRow key={invoice.id}>
											<TableCell className='py-[26px] px-[10px] '>
												<p className='font-medium text-[#212121] text-theme-sm dark:text-white/90'>
													{invoice.qutation_number}
												</p>
											</TableCell>
											<TableCell className='py-[26px] px-[10px]'>
												<div className='flex items-center gap-3 '>{invoice.customer_name}</div>
											</TableCell>
											<TableCell className='py-[26px] px-[10px]'>{invoice.quantity}</TableCell>
