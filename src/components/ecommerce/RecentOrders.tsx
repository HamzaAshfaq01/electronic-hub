  ...
  return (
    <div>
      ...
      <div className="flex justify-end items-center space-x-2 p-4">
        <button className="p-3 py-2 border rounded-lg hover:bg-gray-100">←</button>

        <button className="p-3 py-2 border rounded-lg bg-gray-200 font-semibold">1</button>

        <button className="p-3 py-2 border rounded-lg hover:bg-gray-100">2</button>

        <span className="p-3 py-2">...</span>

        <button className="p-3 py-2 border rounded-lg hover:bg-gray-100">9</button>

        <button className="p-3 py-2 border rounded-lg hover:bg-gray-100">10</button>
