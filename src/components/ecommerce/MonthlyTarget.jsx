		...
		<div className='rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03]'>
			<div className='px-5 pt-5 bg-white shadow-default rounded-2xl pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6'>
				<div className='flex justify-between'>
					<div>
						<h3 className='text-lg font-semibold text-[#212121] dark:text-white/90'>Monthly Target</h3>
						<p className='mt-1 text-gray-500 text-theme-sm dark:text-[#667085]'>Target you’ve set for each month</p>
					</div>
			...
			<div className='flex items-center justify-center gap-5 px-6 py-3.5 sm:gap-8 sm:py-5'>
				<div>
					<p className='mb-1 text-center text-gray-500 text-theme-xs dark:text-[#667085] sm:text-sm'>Target</p>
				...
				<div>
					<p className='mb-1 text-center text-gray-500 text-theme-xs dark:text-[#667085] sm:text-sm'>Revenue</p>
					<p className='flex items-center justify-center gap-1 text-base font-semibold text-[#212121] dark:text-white/90 sm:text-lg'>
						$20K
						<svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
							<path
				...
				<div>
					<p className='mb-1 text-center text-gray-500 text-theme-xs dark:text-[#667085] sm:text-sm'>Today</p>
					<p className='flex items-center justify-center gap-1 text-base font-semibold text-[#212121] dark:text-white/90 sm:text-lg'>
						$20K
						<svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
							<path
