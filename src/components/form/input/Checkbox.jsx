		...
		<label
			...
			<div className='relative w-5 h-5'>
				<input
					id={id}
					type='checkbox'
					className={`w-5 h-5 cursor-pointer  border border-gray-300 rounded-md disabled:opacity-60 
          ${className}`}
					checked={checked}
			...
			{label && <span className='text-sm font-medium text-[#212121] dark:text-gray-200'>{label}</span>}
		</label>
	)
}
