    ...
    <header className="w-full">
      <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4 lg:mb-0 mb-3">
        <div className="w-full flex justify-between items-start lg:flex-row flex-col gap-5">
          ...
          <button
              className="items-center justify-center w-10 h-10 text-gray-500 border-gray-200 rounded-[5px] z-99999 dark:border-gray-800 flex dark:text-gray-400 lg:h-11 lg:w-11 lg:border lg:hidden shadow bg-white"
